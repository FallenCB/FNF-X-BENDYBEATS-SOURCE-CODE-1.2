	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'tank': //Week 7 - Ugh, Guns, Stress
				...
				case 'thedomain': //BendyBeats Week 2/3, I Am Me, BendyBeats Week 3
				    var theDomain:BGSprite = new BGSprite('thedomain', -600, -200);
				    //theDomain.setGraphicSize(Std.int(theDomain.width * 1.1));
				    theDomain.updateHitbox();
				    add(theDomain);

				case 'thestudio': //BendyBeats Week 2 -200, -100
				var theStudio:BGSprite = new BGSprite('thestudio', -200, -100);
				//theDomain.setGraphicSize(Std.int(theDomain.width * 1.1));
				theStudio.updateHitbox();
				add(theStudio);
