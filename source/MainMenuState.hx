...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var bg:FlxSprite = new FlxSprite(-80).loadGraphic(Paths.image('themenubg'));
		...
		char1 = new Character(770, 250, 'bf', true);
		char1.setGraphicSize(Std.int(char1.width * 0.85));
		add(char1);
		char1.visible = false;

		char2 = new Character(760, 190, 'cartoonbendy', true);
		//char2.setGraphicSize(Std.int(char2.width * 1.0));
		add(char2);
		char2.visible = false;

		char3 = new Character(770, -120, 'sammy', true);
		//char3.setGraphicSize(Std.int(char2.width * 1.0));
		add(char3);
		char3.visible = false;

		char4 = new Character(770, 250, 'cb', true);
		...
		add(versionShit);
		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "Bendy Beats v" + vsBendyVersion, 12);
		versionShit.scrollFactor.set();
		versionShit.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
